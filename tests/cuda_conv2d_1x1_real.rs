//! Test conv2d_1x1 with real henc rewrite weights.
...
#[test]
#[ignore]
fn cuda_conv2d_1x1_henc0_rewrite_real_matches_cpu() {
    ...
    let (cpu_out, _) = ops_cpu::conv2d(&input, [b, c_in, fr, t],
        &layer.rewrite, &layer.rewrite_bias, 0, 0, 1, 1);
